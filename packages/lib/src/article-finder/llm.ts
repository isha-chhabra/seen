...
export async function generateSearchQueries(args: {
	...
	const prompt = [
		...
		``,
		`Produce 10-20 Google searches a shopper or editor in the US, Canada, UK, Europe, Australia or NZ would type to surface PUBLISHED editorial roundups, buying guides, "best of" lists and review posts the brand could plausibly be added to.`,
		`Rules:`,
		...
		`- Split roughly evenly between two query types: (a) PRODUCT-ANCHORED queries that name the brand's category (e.g. "best steak gift boxes 2026") to find category-specific roundups, and (b) GENERAL-AUDIENCE queries that do NOT name the product category at all (e.g. "best gifts for dad 2026", "unique gifts for the man who has everything", "best holiday gift guide 2026") to find bigger, broader-audience publications the brand isn't on yet but could be added to as one pick among several. Do not force a category word into every query, that's how the whole batch ends up sounding like one narrow theme instead of the range of angles the direction asked for.`,
		...
		`Good: best insulated water bottles 2026, best gifts for dad 2026   Too narrow: purple 32oz bottle review   Too broad: best outdoor gear`,
