 ...
 */
export const PROVIDERS_DOCS_URL = "https://www.example.com/docs/user-guide/providers";
...
/**
 * Seen brand constants — used for icon generation, manifest, and the brand kit.
 */
export const BRAND_ACCENT_COLOR = "#ec4899"; // pink-500
export const BRAND_DISPLAY_FONT = "Titan One";
export const BRAND_THEME_COLOR = "#ec4899";
export const BRAND_BACKGROUND_COLOR = "#ffffff";

/**
 * Default chart colors for the Seen product.
 *
